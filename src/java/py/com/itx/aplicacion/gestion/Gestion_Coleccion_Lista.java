...
@WebServlet(name = "Gestion_Coleccion_Lista", 
        urlPatterns = {"/Gestion/Coleccion/Lista"})


public class Gestion_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Aplicacion/Gestion/jspf/basictable.jspx").include(request, response);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Gestion_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
