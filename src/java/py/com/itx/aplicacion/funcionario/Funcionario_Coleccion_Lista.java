...
@WebServlet(name = "Funcionario_Coleccion_Lista", 
        urlPatterns = {"/Funcionario/Coleccion/Lista"})


public class Funcionario_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Aplicacion/Funcionario/jspf/basictable.jspx").include(request, response);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Funcionario_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
