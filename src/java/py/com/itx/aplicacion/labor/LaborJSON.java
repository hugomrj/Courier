...
@WebServlet(name = "LaborJSON", 
        urlPatterns = {"/Labor/Linea.json"})


public class LaborJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Labor) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LaborJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
