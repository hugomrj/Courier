...
@WebServlet(name = "Labor_Coleccion_Lista", 
        urlPatterns = {"/Labor/Coleccion/Lista"})


public class Labor_Coleccion_Lista extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Labor_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
