...
@WebServlet(name = "Gestor_Coleccion_Lista", 
        urlPatterns = {"/Gestor/Coleccion/Lista"})


public class Gestor_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Aplicacion/Gestor/jspf/basictable.jspx").include(request, response);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Gestor_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
