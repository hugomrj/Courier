...
@WebServlet(name = "Recurso_Controlador_Borrar",
        urlPatterns = {"/Recurso/Controlador/Borrar"})



public class Recurso_Controlador_Borrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            if ( request.getParameter("recurso") != null) 
            {
                ...
                instancia = (Recurso) persistencia.filtrarId(instancia ,id);
                instancia =  (Recurso) persistencia.delete(instancia);
