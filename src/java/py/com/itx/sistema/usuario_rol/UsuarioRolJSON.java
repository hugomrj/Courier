...
@WebServlet(name = "UsuarioRolJSON", 
        urlPatterns = {"/UsuarioRol/Linea.json"})


public class UsuarioRolJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (UsuarioRol) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UsuarioRolJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
