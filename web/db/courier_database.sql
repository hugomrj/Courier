...
--
-- TOC entry 7 (class 2615 OID 96566)
...
--
-- TOC entry 8 (class 2615 OID 96567)
...
--
-- TOC entry 211 (class 1255 OID 96568)
...
--
-- TOC entry 212 (class 1255 OID 96569)
...
--
-- TOC entry 213 (class 1255 OID 96570)
...
--
-- TOC entry 183 (class 1259 OID 96571)
...
--
-- TOC entry 184 (class 1259 OID 96575)
...
--
-- TOC entry 208 (class 1259 OID 96719)
...
--
-- TOC entry 207 (class 1259 OID 96717)
...
--
-- TOC entry 186 (class 1259 OID 96583)
...
--
-- TOC entry 187 (class 1259 OID 96586)
...
--
-- TOC entry 188 (class 1259 OID 96588)
...
--
-- TOC entry 189 (class 1259 OID 96591)
...
--
-- TOC entry 190 (class 1259 OID 96593)
...
--
-- TOC entry 191 (class 1259 OID 96596)
...
--
-- TOC entry 192 (class 1259 OID 96598)
...
--
-- TOC entry 193 (class 1259 OID 96601)
...
--
-- TOC entry 194 (class 1259 OID 96603)
...
--
-- TOC entry 195 (class 1259 OID 96609)
...
--
-- TOC entry 196 (class 1259 OID 96611)
-- Name: funcionario_categoria; Type: TABLE; Schema: aplicacion; Owner: postgres
--
...
--
-- TOC entry 197 (class 1259 OID 96617)
-- Name: funcionarios; Type: TABLE; Schema: aplicacion; Owner: postgres
--
...
--
-- TOC entry 198 (class 1259 OID 96625)
-- Name: funcionarios_funcionario_seq; Type: SEQUENCE; Schema: aplicacion; Owner: postgres
--

CREATE SEQUENCE funcionarios_funcionario_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE funcionarios_funcionario_seq OWNED BY funcionarios.funcionario;


--
-- TOC entry 199 (class 1259 OID 96627)
-- Name: gestiones; Type: TABLE; Schema: aplicacion; Owner: postgres
--
...
ALTER TABLE gestiones OWNER TO postgres;

--
-- TOC entry 200 (class 1259 OID 96633)
-- Name: gestiones_gestion_seq; Type: SEQUENCE; Schema: aplicacion; Owner: postgres
--

CREATE SEQUENCE gestiones_gestion_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE gestiones_gestion_seq OWNED BY gestiones.gestion;


--
-- TOC entry 201 (class 1259 OID 96635)
-- Name: labores; Type: TABLE; Schema: aplicacion; Owner: postgres
--
...
ALTER TABLE labores OWNER TO postgres;

--
-- TOC entry 202 (class 1259 OID 96641)
-- Name: labores_labor_seq; Type: SEQUENCE; Schema: aplicacion; Owner: postgres
--

CREATE SEQUENCE labores_labor_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE labores_labor_seq OWNED BY labores.labor;


SET search_path = public, pg_catalog;

--
-- TOC entry 203 (class 1259 OID 96643)
...
--
-- TOC entry 204 (class 1259 OID 96654)
...
--
-- TOC entry 205 (class 1259 OID 96656)
...
--
-- TOC entry 206 (class 1259 OID 96668)
...
--
-- TOC entry 2074 (class 2604 OID 96670)
...
--
-- TOC entry 2075 (class 2604 OID 96671)
...
--
-- TOC entry 2076 (class 2604 OID 96672)
-- Name: id; Type: DEFAULT; Schema: administracion; Owner: postgres
--
...
--
-- TOC entry 2077 (class 2604 OID 96673)
...
--
-- TOC entry 2078 (class 2604 OID 96674)
-- Name: id; Type: DEFAULT; Schema: administracion; Owner: postgres
--
...
--
-- TOC entry 2079 (class 2604 OID 96675)
...
--
-- TOC entry 2082 (class 2604 OID 96676)
-- Name: funcionario; Type: DEFAULT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY funcionarios ALTER COLUMN funcionario SET DEFAULT nextval('funcionarios_funcionario_seq'::regclass);


--
-- TOC entry 2083 (class 2604 OID 96677)
-- Name: gestion; Type: DEFAULT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY gestiones ALTER COLUMN gestion SET DEFAULT nextval('gestiones_gestion_seq'::regclass);


--
-- TOC entry 2084 (class 2604 OID 96678)
-- Name: labor; Type: DEFAULT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY labores ALTER COLUMN labor SET DEFAULT nextval('labores_labor_seq'::regclass);


SET search_path = public, pg_catalog;

--
-- TOC entry 2093 (class 2604 OID 96679)
...
--
-- TOC entry 2103 (class 2604 OID 96680)
...
5	Clientes	20	10	/Aplicacion/Cliente/Lista.jspx
...
SELECT pg_catalog.setval('roles_rol_seq', 6, true);
...
SELECT pg_catalog.setval('usuarios_usuario_seq', 7, true);
...
COPY clientes (cliente, ruc, cliente_tipo, cedula, nombre, apellido, razon_social, direccion, telefono, email) FROM stdin;
6	456855	J	0			Empresa A			
8	8544	F	4545	Cliente nombre2	cliente apellido2				
7	454545	F	12345	nombre cliente 1	apellido cliente 1				
9	854654	J	0			Empresa B			
\.
...
SELECT pg_catalog.setval('clientes_cliente_seq', 9, true);
...
COPY funcionario_categoria (categoria, descripcion) FROM stdin;
1	Administrativo
2	Gestor
\.
...
COPY funcionarios (funcionario, cedula, nombre, apellido, fecha_nacimiento, categoria, usuario) FROM stdin;
7	8544	Funcionario1	Gestor1	2017-11-28	2	6
\.
...
SELECT pg_catalog.setval('funcionarios_funcionario_seq', 7, true);
...
COPY gestiones (gestion, cliente, fecha, solicito, destino, gestor, ciudad, labor, monto, retorno, total) FROM stdin;
6	7	2017-11-28	dfsgasdgas	sdgsadgasg	7		5	445	0	0
7	6	2017-11-28	klklk	jkjkj	7		2	121	0	0
8	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
9	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
10	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
19	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
20	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
21	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
22	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
23	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
24	7	2017-11-28	dgasgasdg	gdasdgas	7		2	544	0	0
26	8	2017-11-28	gasdgasd	gdasgas	7		5	4544	0	0
27	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
28	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
29	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
30	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
32	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
35	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
42	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
44	6	2017-11-28	dgasgasd	gsadgasdg	7		2	544	0	0
45	8	2017-11-28	dasgas	dgsdagas	7		5	54545	0	0
46	6	2017-11-28	gasgasg	sdggasg	7		2	8	0	0
47	8	2017-11-28	Hugo Marciano Romero	dgasdgas	7		5	53254354	0	0
\.
...
SELECT pg_catalog.setval('gestiones_gestion_seq', 47, true);
...
COPY labores (labor, descripcion) FROM stdin;
2	Efectivizar cheque
4	
5	Labor agregadas desde modal
\.
...
SELECT pg_catalog.setval('labores_labor_seq', 5, true);
...
--
-- TOC entry 2109 (class 2606 OID 96682)
...
--
-- TOC entry 2119 (class 2606 OID 96684)
...
--
-- TOC entry 2111 (class 2606 OID 96688)
...
--
-- TOC entry 2113 (class 2606 OID 96690)
...
--
-- TOC entry 2115 (class 2606 OID 96692)
...
--
-- TOC entry 2117 (class 2606 OID 96694)
...
--
-- TOC entry 2121 (class 2606 OID 96696)
...
--
-- TOC entry 2123 (class 2606 OID 96698)
...
--
-- TOC entry 2125 (class 2606 OID 96700)
-- Name: funcionario_categoria_pkey; Type: CONSTRAINT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY funcionario_categoria
    ADD CONSTRAINT funcionario_categoria_pkey PRIMARY KEY (categoria);


--
-- TOC entry 2127 (class 2606 OID 96702)
-- Name: funcionarios_pkey; Type: CONSTRAINT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY funcionarios
    ADD CONSTRAINT funcionarios_pkey PRIMARY KEY (funcionario);


--
-- TOC entry 2129 (class 2606 OID 96704)
-- Name: gestiones_pkey; Type: CONSTRAINT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY gestiones
    ADD CONSTRAINT gestiones_pkey PRIMARY KEY (gestion);


--
-- TOC entry 2131 (class 2606 OID 96706)
-- Name: labores_pkey; Type: CONSTRAINT; Schema: aplicacion; Owner: postgres
--

ALTER TABLE ONLY labores
    ADD CONSTRAINT labores_pkey PRIMARY KEY (labor);


SET search_path = public, pg_catalog;

--
-- TOC entry 2135 (class 2606 OID 96708)
...
--
-- TOC entry 2133 (class 2606 OID 96710)
